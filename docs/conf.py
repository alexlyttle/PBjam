...
latex_documents = [
    (master_doc, 'PBjam.tex', 'PBjam Documentation',
     'Martin Nielsen', 'manual'),
]
...
man_pages = [
    (master_doc, 'pbjam', 'PBjam Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PBjam', 'PBjam Documentation',
     author, 'PBjam', 'One line description of project.',
     'Miscellaneous'),
]
